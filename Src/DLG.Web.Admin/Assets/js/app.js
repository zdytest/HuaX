var App = function () {
    ...
    var handleMainSubMenu = function () {

        jQuery('.page-sidebar .has-secondsub > a').click(function () {
            ...
            var last = jQuery('.has-secondsub.open', $('.page-sidebar'));
            if (last.size() == 0) {
                //last = jQuery('.has-sub.active', $('.page-sidebar'));
            }
            last.removeClass("open");
            jQuery('.arrow', last).removeClass("open");
            jQuery('.secondsub', last).slideUp(200);
    ...
    return {
        ...
        init: function () {
            ...
            handleMainSubMenu();// handles main menu
